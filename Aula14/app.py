...
class Application:
    def __init__(self, master=None):
        ...
        print("Criação de Label no 1º Container")
        self.titulo = Label(self.container1, text="Informe os dados :")
        self.titulo["font"] = ("Calibri", "9", "bold")
        self.titulo.pack ()

        print("Criação de Label, Entry e Button no 2º Container")
        ...
        print("Criação de Label e Entry no 3º Container - NOME")
        ...
        print("Criação de Label e Entry no 4º Container - TELEFONE")
        ...
        print("Criação de Label e Entry no 5º Container - EMAIL")
        ...
        print("Criação de Label e Entry no 6º Container - USUÁRIO")
        ...
        print("Criação de Label e Entry no 7º Container - SENHA")
        ...
        print("Criação de Buttons no 8º Container")
...
print("####Início do programa - App de Usuários####")
root = Tk()
Application(root)
root.mainloop()