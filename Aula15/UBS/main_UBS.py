...
def lerArquivo():
    ...
    ref_arq_UBS = open("Y:/Inteligencia-Artificial/Aula15/UBS/UBS_Modificado.csv","r")
...
def ImprimeUFsCodigos():    
    ref_arq_UFs = open("Y:/Inteligencia-Artificial/Aula15/UBS/Tabela-Codigo-UF-IBGE.txt","r")
...
def processamentoDeDados():
    df = pd.read_csv("Y:/Inteligencia-Artificial/Aula15/UBS/UBS_Modificado.csv")
